...
class ColorRepositoryImplTest {
    ...
    @Test
    fun `getSetOfUniqueColorsFromApiService returns a set of ColorModel without names from common`() = runTest {
        mockApiResponse { (h, s, v) ->
            ColorResponse(
                name = Name(""),
                hsv = Hsv(fraction = Hsv.Fraction(h, s, v))
    ...
    @Test
    fun `getSetOfUniqueColorsFromApiService returns a set of ColorModel with proper value and saturation`() = runTest {
        mockApiResponse { (h, s, v) ->
            ColorResponse(
                name = Name(""),
                hsv = Hsv(fraction = Hsv.Fraction(h, s, v))
